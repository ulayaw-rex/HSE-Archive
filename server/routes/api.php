...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/publications/{id}/status', [PublicationController::class, 'updateStatus']);
    ...
    Route::middleware('role:admin')->group(function () {
        ...
        // Added Print Media Creation/Editing routes for Admins
        Route::post('/print-media', [PrintMediaController::class, 'store']);
        Route::put('/print-media/{print_media}', [PrintMediaController::class, 'update']);
        Route::delete('/print-media/{print_media}', [PrintMediaController::class, 'destroy']);
