...
const ConfirmationModal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm transition-opacity">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all scale-100 animate-fade-in-up border border-gray-200 dark:border-gray-700">
        <div
        ...
        <div className="p-6">
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg border border-gray-100 dark:border-gray-600 text-xs text-gray-500 dark:text-gray-400 flex gap-2 items-start transition-colors">
        ...
        <div className="p-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-800 flex justify-end gap-3 transition-colors">
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm font-medium text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
            disabled={isLoading}
          >
            Cancel
          </button>
...
const ModuleSkeleton = () => (
  <div className="rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 animate-pulse h-full transition-colors">
  ...
  return (
    <div className="p-4 md:p-8 bg-gray-50 dark:bg-gray-900 min-h-screen font-sans text-gray-800 dark:text-gray-200 transition-colors duration-200">
      ...
      <div className="mb-8 md:mb-10">
        <h1 className="text-2xl md:text-3xl font-extrabold text-gray-900 dark:text-gray-100 tracking-tight mb-2 transition-colors">
          System Modules
        </h1>
        <p className="text-gray-500 dark:text-gray-400 text-base md:text-lg transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
        {loading ? (
          ...
          >
            ...
            <div className="p-5 md:p-6">
              ...
              <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-gray-100 mb-2 transition-colors">
                System Maintenance
              </h3>

              <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 min-h-[40px] transition-colors">
                {isLocked
        ...
        <div className="border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-2xl flex flex-col items-center justify-center p-8 text-center text-gray-400 dark:text-gray-500 hover:border-gray-300 dark:hover:border-gray-600 transition-colors h-full min-h-[300px]">
          <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-full mb-3 transition-colors">
            <FaInfoCircle
              size={24}
              className="text-gray-300 dark:text-gray-600"
            />
          </div>
          <h3 className="font-semibold text-gray-500 dark:text-gray-400 transition-colors">
