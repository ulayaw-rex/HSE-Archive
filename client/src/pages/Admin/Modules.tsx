      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all scale-100">
        ...
        >
          ...
          >
            ...
            {isLocking ? "Enable Maintenance Mode?" : "Restore System Access?"}
          </h3>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          ...
          <div className="bg-gray-50 p-3 rounded-lg border border-gray-100 text-xs text-gray-500 flex gap-2">
...
const ModuleSkeleton = () => (
  <div className="rounded-2xl shadow-sm border border-gray-100 bg-white p-6 animate-pulse">
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen font-sans text-gray-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-4">
                ...
                >
                  {isLocked ? "Maintenance Mode" : "System Online"}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                ...
                <button
                  ...
                  disabled={toggling}
                  className={`flex items-center gap-2 px-5 py-2 rounded-lg font-medium transition-all duration-200 shadow-sm focus:ring-4 ${
                    isLocked
        ...
        <div className="border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center p-8 text-center text-gray-400 hover:border-gray-300 transition-colors">
